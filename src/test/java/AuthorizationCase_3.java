...
@Test
public class AuthorizationCase_3 {
    ...
    public void case_3(String StartUrl, String UrlAssert) throws InterruptedException {
        ...
        email.sendKeys("qqqawpt@ukr.net");

        //Находим и вводим Password
        WebElement password = driver.findElement(By.id("password"));
        password.sendKeys("@Coinzix17");

        //Находим кнопку отобрахить пароль
        WebElement ShowPsswBtn = driver.findElement(By.xpath("//button[@class='show-pass__button']"));
        ShowPsswBtn.click();
        Thread.sleep(2500);
