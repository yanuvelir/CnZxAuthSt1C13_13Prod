...
@Test
public class AuthorizationCase_7 {
    ...
    public void case_7(String StartUrl, String UrlAssert) throws InterruptedException {
        ...
        //Находим и вводи Email Email=Valid
        WebElement email = driver.findElement(By.id("email"));
        email.sendKeys("qawpt@ukr.net");

        //Находим и вводим Password. Pass=Null
